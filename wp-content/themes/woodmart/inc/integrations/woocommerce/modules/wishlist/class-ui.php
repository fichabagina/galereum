...
class Ui extends Singleton {
	...
	public function wishlist_empty_content( $show_wishlist_empty_text = true ) {
		...
		<p class="wd-empty-wishlist wd-empty-page">
			<?php esc_html_e( 'Список избранных пуст.', 'woodmart' ); ?>
		</p>
		...
		<?php if ( $show_wishlist_empty_text && $this->is_editable() ) : ?>
			<p class="return-to-shop">
				<a class="button" href="<?php echo esc_url( apply_filters( 'woodmart_wishlist_return_to_shop_url', wc_get_page_permalink( 'shop' ) ) ); ?>">
					<?php esc_html_e( 'Вернуться в каталог', 'woodmart' ); ?>
				</a>
			</p>
		<?php endif; ?>
		<?php
	...
	public function add_to_wishlist_btn( $classes = '' ) {
		...
		$added        = false;
		$link_classes = '';
		$text         = esc_html__( 'Добавить в избранное', 'woodmart' );
		...
		if ( $added ) {
			$link_classes .= ' added';
			$text          = esc_html__( 'Добавлено в избранное', 'woodmart' );
		}
		...
		?>
			<div class="wd-wishlist-btn <?php echo esc_attr( $classes ); ?>">
				<a class="<?php echo esc_attr( $link_classes ); ?>" href="<?php echo esc_url( woodmart_get_wishlist_page_url() ); ?>" data-key="<?php echo esc_attr( wp_create_nonce( 'woodmart-wishlist-add' ) ); ?>" data-product-id="<?php echo esc_attr( $product_id ); ?>" rel="nofollow" data-added-text="<?php esc_html_e( 'Добавленно в избранное', 'woodmart' ); ?>">
